...
function compose(...functions) {
  return function(arg) {
    ...
    const last3 = functions[functions.length - 1];
    const rest = functions.slice(0, -1);
    return rest.reduceRight((composed, fn) => fn(composed), last3(arg));
  };
}
...
function isComponent(target) {
  return isFunction2(target) && target.hasOwnProperty("\u0275cmp");
}
...
function freeze(target) {
  ...
  const targetIsFunction = isFunction2(target);
  Object.getOwnPropertyNames(target).forEach((prop) => {
    ...
    if (hasOwnProperty(target, prop) && (targetIsFunction ? prop !== "caller" && prop !== "callee" && prop !== "arguments" : true)) {
      ...
      if ((isObjectLike(propValue) || isFunction2(propValue)) && !Object.isFrozen(propValue)) {
        freeze(propValue);
      }
    }
  });
...
function getUnserializable(target, path = []) {
  ...
  return keys.reduce((result, key) => {
    ...
    if (isUndefined(value) || isNull(value) || isNumber(value) || isBoolean2(value) || isString(value) || isArray(value)) {
      return false;
    }
...
function reportInvalidActions(output, reporter) {
  if (output.notification.kind === "N") {
    ...
    if (isInvalidAction) {
      reporter.handleError(new Error(`Effect ${getEffectName(output)} dispatched an invalid action: ${stringify3(action)}`));
    }
  }
}
...
function isOnIdentifyEffects(instance) {
  return isFunction3(instance, onIdentifyEffectsKey);
}
var onRunEffectsKey = "ngrxOnRunEffects";
function isOnRunEffects(instance) {
  return isFunction3(instance, onRunEffectsKey);
}
var onInitEffects = "ngrxOnInitEffects";
function isOnInitEffects(instance) {
  return isFunction3(instance, onInitEffects);
}
function isFunction3(instance, functionName) {
...
// src/app/sudoku-sdk/sudoku.action.ts
var sudokuActions = createActionGroup({
  source: "Sudoku API",
  events: {
    "Submit Game Details": props(),
    "Submit Game Details Success": props(),
    "Submit Game Details Failure": (error) => ({ error }),
    "Generate Extra Board": props(),
    "Update Board One": props(),
    "Update Board Two": props(),
    "Solve Board One": emptyProps(),
    "Solve Board Two": emptyProps(),
    "Solve Board One Success": props(),
    "Solve Board Two Success": props(),
...
var BoardComponent_Defer_3_DepsFn = () => [NgClass, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, FormControlName, import("./chunk-SOMLPFL3.js").then((m) => m.InputValidatorDirective)];
function BoardComponent_Defer_1_For_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "input", 2);
  }
  if (rf & 2) {
    ...
    \u0275\u0275propertyInterpolate1("formControlName", "inputControl", $index_r1, "");
    \u0275\u0275property("ngClass", ctx_r1.isMultiMode ? "multi-input" : "single-input");
  }
}
function BoardComponent_Defer_1_For_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "input", 3);
  }
  if (rf & 2) {
    const value_r3 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngClass", ctx_r1.isMultiMode ? "multi-input" : "single-input")("value", value_r3);
  }
}
function BoardComponent_Defer_1_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, BoardComponent_Defer_1_For_1_Conditional_0_Template, 1, 3, "input", 1)(1, BoardComponent_Defer_1_For_1_Conditional_1_Template, 1, 2);
  }
  if (rf & 2) {
    const value_r3 = ctx.$implicit;
    \u0275\u0275conditional(0, value_r3 === 0 ? 0 : 1);
  }
}
function BoardComponent_Defer_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, BoardComponent_Defer_1_For_1_Template, 2, 1, null, null, \u0275\u0275repeaterTrackByIndex);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275repeater(ctx_r1.flattenedBoard());
  }
}
function BoardComponent_DeferPlaceholder_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Loading... ");
  }
}
  ...
  ngOnInit() {
    const initBoard$ = this.boardConfig$.subscribe((board) => {
      ...
      for (let i = 0; i < this.flattenedBoard().length; i++) {
        ...
        this.boardForm.addControl(formControlName, new FormControl(this.flattenedBoard()[i] === 0 ? "" : this.flattenedBoard()[i]));
      }
    });
...
_BoardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BoardComponent, selectors: [["app-board"]], inputs: { boardConfig$: "boardConfig$", isPlayerOne: "isPlayerOne", isMultiMode: "isMultiMode" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 5, vars: 2, consts: [[3, "formGroup"], ["type", "number", "appInputValidator", ""], ["type", "number", "appInputValidator", "", 3, "formControlName", "ngClass", "value"], ["type", "number", "disabled", "", 3, "ngClass", "value"]], template: function BoardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BoardComponent_Defer_1_Template, 2, 0)(2, BoardComponent_DeferPlaceholder_2_Template, 1, 0);
    \u0275\u0275defer(3, 1, BoardComponent_Defer_3_DepsFn, null, 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275property("formGroup", ctx.boardForm);
    \u0275\u0275advance(3);
    \u0275\u0275deferWhen(ctx.flattenedBoard().length);
  }
}, dependencies: [CommonModule, ReactiveFormsModule, \u0275NgNoValidate, NgControlStatusGroup, FormGroupDirective], styles: ["\n\nform[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: auto auto auto auto auto auto auto auto auto;\n  border: 2px solid var(--primary-color);\n}\n.single-input[_ngcontent-%COMP%] {\n  width: 64px;\n  height: 64px;\n  text-align: center;\n  font-size: 32px;\n}\n.multi-input[_ngcontent-%COMP%] {\n  width: 44px;\n  height: 44px;\n  text-align: center;\n  font-size: 24px;\n}\n@media only screen and (max-width: 768px) {\n  .single-input[_ngcontent-%COMP%] {\n    width: 32px;\n    height: 32px;\n    text-align: center;\n    font-size: 16px;\n  }\n}\n/*# sourceMappingURL=board.component.css.map */"], changeDetection: 0 });
var BoardComponent = _BoardComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BoardComponent, { className: "BoardComponent", filePath: "src/app/board/board.component.ts", lineNumber: 21 });
})();

// src/app/sudoku-sdk/sudoku.selector.ts
var selectSudokuAppState = createFeatureSelector("sudoku");
...
var selectBoardTwoInitial = createSelector(selectSudokuAppState, (state) => state.initialBoardTwo);
var selectIsValid = createSelector(selectSudokuAppState, (state) => state.isValid);
var selectIsSolved = createSelector(selectSudokuAppState, (state) => state.isSolved);

// src/app/board-container/board-container.component.ts
function BoardContainerComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 8);
    \u0275\u0275listener("click", function BoardContainerComponent_Conditional_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function BoardContainerComponent_Conditional_7_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function BoardContainerComponent_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275property("isMultiMode", true)("isPlayerOne", true)("boardConfig$", ctx_r1.boardOne$);
    \u0275\u0275advance(6);
...
var _BoardContainerComponent = class _BoardContainerComponent {
  constructor(store) {
    this.store = store;
    this.difficulty$ = this.store.select(selectDifficulty);
    this.isSingle$ = this.store.select(selectIsSingleMode);
    this.boardOne$ = this.store.select(selectBoardOneInitial);
...
function MenuComponent_For_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", elem_r1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 2, elem_r1));
  }
}
...
_MenuComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MenuComponent, selectors: [["app-menu"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 19, vars: 2, consts: [[1, "grid-container"], [1, "menu-panel"], ["data-testid", "game-title", 1, "title"], [1, "form-container", 3, "ngSubmit", "formGroup"], ["for", "players", 1, "information-label"], ["data-testid", "game-mode-selector", "formControlName", "gameMode", "id", "players"], ["value", "single"], ["value", "multi"], ["for", "levels", 1, "information-label"], ["data-testid", "difficulty-selector", "formControlName", "gameDifficulty", "id", "levels"], ["data-testid", "start-cta", 1, "submit-btn", 3, "disabled"], [3, "value"]], template: function MenuComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1", 2);
    \u0275\u0275text(3, "Sudoku Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "form", 3);
    \u0275\u0275listener("ngSubmit", function MenuComponent_Template_form_ngSubmit_4_listener() {
      return ctx.onSubmit();
    });
    \u0275\u0275elementStart(5, "label", 4);
    \u0275\u0275text(6, "Choose game mode:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "select", 5)(8, "option", 6);
    \u0275\u0275text(9, "1 Player");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(13, "Choose level:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "select", 9);
    \u0275\u0275repeaterCreate(15, MenuComponent_For_16_Template, 3, 4, "option", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275property("formGroup", ctx.menuForm);
    \u0275\u0275advance(11);
...
// src/app/utils/game.guard.ts
var gameGuard = () => {
  const store = inject(Store);
  const router = inject(Router);
  return store.select(selectDifficulty).pipe(map((gameMode) => !!gameMode), tap((isGameMode) => {
    if (!isGameMode) {
...
// src/app/sudoku-sdk/sudoku.service.ts
var GET_BOARD = "https://sugoku.onrender.com/board";
var VALIDATE_BOARD = "https://sugoku.onrender.com/validate";
var SOLVE_BOARD = "https://sugoku.onrender.com/solve";
var _SudokuService = class _SudokuService {
  constructor() {
    this.httpClient = inject(HttpClient);
  }
  generateSudokuBoard(difficulty) {
    return this.httpClient.get(GET_BOARD, { params: { difficulty } }).pipe(catchError(() => of({ board: [[]] })));
  }
  validateSudokuBoard(board) {
    const sudokuRequest = {
      board
    };
    return this.httpClient.post(VALIDATE_BOARD, sudokuRequest).pipe(catchError(() => EMPTY));
  }
  solveSudokuBoard(board) {
    const sudokuRequest = {
      board
    };
    return this.httpClient.post(SOLVE_BOARD, sudokuRequest).pipe(catchError(() => EMPTY));
  }
};
_SudokuService.\u0275fac = function SudokuService_Factory(t) {
  return new (t || _SudokuService)();
};
_SudokuService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SudokuService, factory: _SudokuService.\u0275fac, providedIn: "root" });
var SudokuService = _SudokuService;

// src/app/sudoku-sdk/sudoku.effect.ts
var _SudokuEffect = class _SudokuEffect {
  constructor(actions$, sudokuService, router, store) {
    this.actions$ = actions$;
    this.sudokuService = sudokuService;
    this.router = router;
    this.store = store;
    this.submitGameDetails$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.submitGameDetails), switchMap((payload) => this.sudokuService.generateSudokuBoard(payload.gameDifficulty).pipe(map((boardResponse) => {
        const startState = {
    ...
    this.submitGameDetailsSuccess$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.submitGameDetailsSuccess), tap((payload) => {
        if (payload.startState.gameMode === "single") {
          this.router.navigate(["/board"]);
        }
      }), filter((payload) => payload.startState.gameMode === "multi"), switchMap((payload) => this.sudokuService.generateSudokuBoard(payload.startState.difficulty).pipe(map((boardResponse) => {
        return sudokuActions.generateExtraBoard({ board: boardResponse.board });
      }))));
    });
    this.generateExtraBoard$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.generateExtraBoard), tap(() => this.router.navigate(["/board"])));
    }, { dispatch: false });
    this.solveBoardOne$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.solveBoardOne), concatLatestFrom(() => this.store.select(selectBoardOneInGame)), switchMap(([, inGameBoard]) => {
        return this.sudokuService.solveSudokuBoard(inGameBoard).pipe(map((response) => {
    ...
    this.solveBoardTwo$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.solveBoardTwo), concatLatestFrom(() => this.store.select(selectBoardTwoInGame)), switchMap(([, inGameBoard]) => {
        return this.sudokuService.solveSudokuBoard(inGameBoard).pipe(map((response) => {
          if (response.status === "solved") {
    ...
    this.validateBoardOne$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.validateBoardOne), concatLatestFrom(() => this.store.select(selectBoardOneInGame)), switchMap(([, inGameBoard]) => {
        return this.sudokuService.validateSudokuBoard(inGameBoard).pipe(map((response) => {
          if (response.status === "solved") {
    ...
    this.validateBoardTwo$ = createEffect(() => {
      return this.actions$.pipe(ofType(sudokuActions.validateBoardTwo), concatLatestFrom(() => this.store.select(selectBoardTwoInGame)), switchMap(([, inGameBoard]) => {
        return this.sudokuService.validateSudokuBoard(inGameBoard).pipe(map((response) => {
          if (response.status === "solved") {
...
_SudokuEffect.\u0275fac = function SudokuEffect_Factory(t) {
  return new (t || _SudokuEffect)(\u0275\u0275inject(Actions), \u0275\u0275inject(SudokuService), \u0275\u0275inject(Router), \u0275\u0275inject(Store));
};
_SudokuEffect.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SudokuEffect, factory: _SudokuEffect.\u0275fac });
var SudokuEffect = _SudokuEffect;

// src/app/sudoku-sdk/sudoku.reducer.ts
var initialState = {
  gameMode: void 0,
  difficulty: void 0,
  initialBoardOne: [],
...
}), on(sudokuActions.updateBoardOne, (state, { board }) => {
  return __spreadProps(__spreadValues({}, state), {
    inGameBoardOne: board
  });
}), on(sudokuActions.updateBoardTwo, (state, { board }) => {
  return __spreadProps(__spreadValues({}, state), {
    inGameBoardTwo: board
  });
}), on(sudokuActions.solveBoardOneSuccess, (state, { board }) => {
  return __spreadProps(__spreadValues({}, state), {
...
}), on(sudokuActions.solveBoardTwoFailure, (state) => {
  return __spreadProps(__spreadValues({}, state), {
    isValid: false
  });
...
}), on(sudokuActions.validateBoardTwoFailure, (state) => {
  return __spreadProps(__spreadValues({}, state), {
    isValid: false
  });
}), on(sudokuActions.solvingConfirmed, (state) => {
  return __spreadProps(__spreadValues({}, state), {
    isSolved: false
  });
}), on(sudokuActions.validityConfirmed, (state) => {
  return __spreadProps(__spreadValues({}, state), {
    isValid: true
  });
}), on(sudokuActions.restartGame, (state) => {
  return __spreadProps(__spreadValues({}, state), {
...
}, dependencies: [RouterOutlet, RouterModule], styles: ["\n\n/*# sourceMappingURL=app.component.css.map */"] });
